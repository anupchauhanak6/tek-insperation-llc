    ...
    >
      ...
      <div className="max-w-287.5 mx-auto relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12.5 text-center lg:text-left">
        ...
        <div className="flex-[1.1] flex flex-col justify-center items-center lg:items-start w-full">
          <div
            className={cn(
              "inline-flex items-center gap-1.5 text-[#10b981] bg-white py-1 px-3 rounded-full text-[0.65rem] font-extrabold uppercase tracking-[1px] mb-3.75 border border-[#10b981]/20 shadow-[0_4px_10px_rgba(0,0,0,0.02)] transition-all duration-[600ms] ease-out",
              isVisible
          ...
          <h2
            className={cn(
              "text-[1.6rem] lg:text-[clamp(1.5rem,2.5vw,1.8rem)] text-slate-900 font-extrabold leading-[1.2] m-0 mb-3.75 tracking-[-0.5px] transition-all duration-[600ms] ease-out delay-100",
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-[15px]",
            )}
          ...
          <p
            className={cn(
              "text-[0.85rem] text-slate-600 leading-[1.6] m-0 mb-5 font-medium transition-all duration-[600ms] ease-out delay-200 lg:max-w-none max-w-xl",
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-[15px]",
            )}
          ...
          <div
            className={cn(
              "bg-white border-l-[3px] border-[#10b981] py-3 px-[18px] mb-5 rounded-r-lg shadow-[0_8px_25px_rgba(15,23,42,0.03)] text-left transition-all duration-[600ms] ease-out delay-300 lg:max-w-none max-w-xl",
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-[15px]",
            )}
          ...
          <p
            className={cn(
              "text-[0.8rem] text-slate-600 leading-[1.6] m-0 mb-[25px] font-medium transition-all duration-[600ms] ease-out delay-[400ms] lg:max-w-none max-w-xl",
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-[15px]",
            )}
          ...
          <div
            className={cn(
              "transition-all duration-[600ms] ease-out delay-[500ms]",
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-[15px]",
            )}
          >
            ...
            >
              ...
              <i
                className="fas fa-arrow-right text-[0.65rem] transition-transform duration-300 group-hover/btn:translate-x-[3px]"
                aria-hidden="true"
              />
            </a>
          </div>
        ...
        <div
          className={cn(
            "flex-1 relative flex justify-center lg:justify-end w-full transition-all duration-[600ms] ease-out delay-[600ms] group/visuals",
            isVisible
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-[15px]",
          )}
        >
          <div className="relative w-full max-w-full md:max-w-[420px] h-[300px] lg:h-[380px] rounded-xl lg:rounded-2xl overflow-hidden shadow-[0_20px_40px_rgba(15,23,42,0.08)] z-10 border-4 border-white">
            <img
              ...
              className="w-full h-full object-cover transition-transform duration-[600ms] ease-out group-hover/visuals:scale-105"
            />
          </div>

          {/* Floating Glass Card */}
          <div
            className="absolute left-2.5 lg:-left-[30px] bottom-4 lg:bottom-[30px] bg-white/95 backdrop-blur-[10px] p-[10px_12px] lg:p-[12px_16px] rounded-[10px] shadow-[0_10px_25px_rgba(0,0,0,0.08)] z-20 flex items-center gap-2.5 border border-black/5"
          ...
          >
            ...
            <div className="flex flex-col text-left">
              <strong className="text-[0.85rem] font-extrabold text-slate-900 block leading-none mb-[3px]">
                Enterprise
              </strong>
